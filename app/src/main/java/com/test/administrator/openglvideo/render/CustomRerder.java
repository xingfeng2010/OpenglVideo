...
public class CustomRerder implements GLSurfaceView.Renderer {
    ...
    public CustomRerder(Context context) {
        mContext = context;
        initPositionData();
        initTextureData();
    }
    ...
    private void initProgram() {
        String vertexShaderSource = TextResourceReader
                .readTextFileFromResource(mContext, R.raw.texture_vertex_shader);
        String fragmentShaderSource = TextResourceReader
                .readTextFileFromResource(mContext, R.raw.texture_fragment_shader);
