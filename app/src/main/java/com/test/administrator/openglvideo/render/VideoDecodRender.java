...
public class VideoDecodRender implements GLSurfaceView.Renderer {
    ...
    public VideoDecodRender(Context context) {
        mContext = context;
        initData();
    }
    ...
    public void onCreate(int mOutputVideoWidth, int mOutputVideoHeight) {
    }
