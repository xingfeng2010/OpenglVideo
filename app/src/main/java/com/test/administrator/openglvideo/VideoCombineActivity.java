...
public class VideoCombineActivity extends AppCompatActivity {
    ...
    public void combineTwoVideos(String audioVideoPath,
        ...
        Log.i(TAG, "combineTwoVideos audioVideoPath:" + audioVideoPath);
        Log.i(TAG, "combineTwoVideos frameVideoPath:" + frameVideoPath);
        MediaExtractor audioVideoExtractor = null;
        ...
        try {
            ...
            audioVideoExtractor = new MediaExtractor();
